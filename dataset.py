...
class IEMOCAPDataset(Dataset):
    ...
    def collate_fn(self, data):
        ...
        textf = pad_sequence([d[0] for d in data], True)
        visuf = pad_sequence([d[1] for d in data], True)
        acouf = pad_sequence([d[2] for d in data], True)
        ...
        return textf, visuf, acouf, qmask, umask, labels, length_mm
